      ...
      <div id="elemento-para-pdf" class="StyleFontDocument alignTextJustify">
        <div class="row" style="line-height: 1.5">
          ...
          <div class="col-12 text-center">
            ...
            <p class="text-small top-subtitle"><b>(Gabinete do Director)</b></p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <br />
            <br />
            <b>GUIA DE FÉRIAS Nº_______/G.D.M/{{ dateNowYear }}</b>
          </div>

          <div class="col-12" style="line-height: 1.5">
            <br />

            Para os devidos efeitos achados convenientes, faz-se constar as
            ...
            <br />
            <br />
            Por ser verdade e me ter sido solicitado, mandei passar a presente
            <b>Guia</b> que vai por mim assinada e autenticada com carimbo à
            óleo em uso nesta Direcção Municipal
            <br />
          </div>
